...
<!--  <img src="assets/img/desktop2.png" style="top: -5px;right: 138px;opacity:0.8; text-align: center;position: absolute;z-index:100;"/> -->
    <div class="pre-sale row justify-content-center">
      <div class="col-md-12">
              ...
              <div class="container-pre-sale-purple">
                ...
                <div class="registration-container-presale">
                  ...
                  <div class="registration-container-graphics">
                    ...
                    <img class="second-graphic-coins" style="position: absolute; left: 91%; top: 15.5%; width: 12%;" src="assets/img/coins-presale.png"/>
                  </div>
                </div>
              </div>
              <div class="second-container-presale">
                <div class="col-md-6">
                  <div class="second-section-presale-heading">
                    <h2 class="headings-text-box-presale">Bonus Structure</h2>
                    <p style="position:relative;left:50px;">Participation in the Pre-Sale ensures additional bonus tokens from the 80M tokens being made available in the token sale. </p>
